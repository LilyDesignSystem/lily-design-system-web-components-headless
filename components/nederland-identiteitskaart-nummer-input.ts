...
//
// A headless input for entering the Netherlands's Identiteitskaart Nummer.
...
//
// References:
//   - components/nederland-identiteitskaart-nummer-input/index.md (canonical contract)
...
export class NederlandIdentiteitskaartNummerInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "nederland-identiteitskaart-nummer-input");
