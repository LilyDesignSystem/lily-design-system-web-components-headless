...
//
// References:
//   - components/australia-individual-healthcare-identifier-input/index.md (canonical contract)
...
export class AustraliaIndividualHealthcareIdentifierInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "australia-individual-healthcare-identifier-input");
