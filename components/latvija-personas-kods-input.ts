// LatvijaPersonasKodsInput component
//
// A headless input for entering Latvia's Personas kods.
...
//
// References:
//   - components/latvija-personas-kods-input/index.md (canonical contract)
...
export class LatvijaPersonasKodsInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "latvija-personas-kods-input");
