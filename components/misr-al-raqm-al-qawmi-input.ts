...
//
// A headless input for entering Egypt's الرقم القومي (National Number).
...
//
// References:
//   - components/misr-al-raqm-al-qawmi-input/index.md (canonical contract)
...
export class MisrAlRaqmAlQawmiInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "misr-al-raqm-al-qawmi-input");
