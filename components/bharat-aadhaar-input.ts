...
//
// References:
//   - components/bharat-aadhaar-input/index.md (canonical contract)
...
export class BharatAadhaarInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "bharat-aadhaar-input");
