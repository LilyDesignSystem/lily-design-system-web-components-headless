...
//
// A headless input for entering Lithuania's Pasas (passport).
...
//
// References:
//   - components/lietuva-pasas-input/index.md (canonical contract)
...
export class LietuvaPasasInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "lietuva-pasas-input");
