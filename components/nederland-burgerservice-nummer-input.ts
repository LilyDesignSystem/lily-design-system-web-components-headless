...
//
// A headless input for entering the Netherlands's Burgerservicenummer (BSN).
...
//
// References:
//   - components/nederland-burgerservice-nummer-input/index.md (canonical contract)
...
export class NederlandBurgerserviceNummerInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "nederland-burgerservice-nummer-input");
