// NederlandPaspoortNummerInput component
//
// A headless input for entering the Netherlands's Paspoort Nummer.
...
//
// References:
//   - components/nederland-paspoort-nummer-input/index.md (canonical contract)
...
export class NederlandPaspoortNummerInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "nederland-paspoort-nummer-input");
