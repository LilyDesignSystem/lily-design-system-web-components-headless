...
//
// References:
//   - components/italia-codice-fiscale-input/index.md (canonical contract)
...
export class ItaliaCodiceFiscaleInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "italia-codice-fiscale-input");
