...
//
// References:
//   - components/norge-fodselsnummer-input/index.md (canonical contract)
...
export class NorgeFodselsnummerInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "norge-fodselsnummer-input");
