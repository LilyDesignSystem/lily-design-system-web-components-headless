...
//
// References:
//   - components/indonesia-nomor-induk-kependudukan-input/index.md (canonical contract)
...
export class IndonesiaNomorIndukKependudukanInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "indonesia-nomor-induk-kependudukan-input");
