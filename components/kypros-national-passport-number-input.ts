...
//
// References:
//   - components/kypros-national-passport-number-input/index.md (canonical contract)
...
export class KyprosNationalPassportNumberInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "kypros-national-passport-number-input");
