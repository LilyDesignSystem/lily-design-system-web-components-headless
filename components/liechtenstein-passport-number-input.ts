...
//
// A headless input for entering Liechtenstein's passport number.
...
//
// References:
//   - components/liechtenstein-passport-number-input/index.md (canonical contract)
...
export class LiechtensteinPassportNumberInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "liechtenstein-passport-number-input");
