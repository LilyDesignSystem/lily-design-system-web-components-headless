...
//
// References:
//   - components/alba-community-health-index-input/index.md (canonical contract)
...
export class AlbaCommunityHealthIndexInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "alba-community-health-index-input");
