...
//
// References:
//   - components/england-national-health-service-number-input/index.md (canonical contract)
...
export class EnglandNationalHealthServiceNumberInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "england-national-health-service-number-input");
