...
//
// References:
//   - components/chile-rol-unico-nacional-input/index.md (canonical contract)
...
export class ChileRolUnicoNacionalInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "chile-rol-unico-nacional-input");
