...
//
// References:
//   - components/romania-cod-numeric-personal-input/index.md (canonical contract)
...
export class RomaniaCodNumericPersonalInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "romania-cod-numeric-personal-input");
