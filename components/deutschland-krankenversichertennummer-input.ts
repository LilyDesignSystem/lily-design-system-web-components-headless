...
//
// References:
//   - components/deutschland-krankenversichertennummer-input/index.md (canonical contract)
...
export class DeutschlandKrankenversichertennummerInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "deutschland-krankenversichertennummer-input");
