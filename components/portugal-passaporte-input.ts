// PortugalPassaporteInput component
//
// A headless input for entering Portugal's Passaporte.
...
//
// References:
//   - components/portugal-passaporte-input/index.md (canonical contract)
...
export class PortugalPassaporteInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "portugal-passaporte-input");
