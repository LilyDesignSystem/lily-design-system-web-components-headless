...
//
// References:
//   - components/danmark-personnummer-input/index.md (canonical contract)
...
export class DanmarkPersonnummerInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "danmark-personnummer-input");
