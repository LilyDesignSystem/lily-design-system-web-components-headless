...
//
// A decorative <div> that looks like a desktop window, framing consumer-supplied
...
//
// References:
//   - components/mockup-window/index.md (canonical contract)

import { applySelfClassName } from "../lib/dom-utils.js";

export class MockupWindow extends HTMLElement {
    #built = false;
    ...
    connectedCallback(): void {
        ...
        applySelfClassName(this, "mockup-window");
