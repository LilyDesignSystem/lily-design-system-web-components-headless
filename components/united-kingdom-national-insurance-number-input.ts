...
//
// References:
//   - components/united-kingdom-national-insurance-number-input/index.md (canonical contract)
...
export class UnitedKingdomNationalInsuranceNumberInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "united-kingdom-national-insurance-number-input");
