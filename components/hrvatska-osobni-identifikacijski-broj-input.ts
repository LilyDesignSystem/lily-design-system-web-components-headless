...
//
// References:
//   - components/hrvatska-osobni-identifikacijski-broj-input/index.md (canonical contract)
...
export class HrvatskaOsobniIdentifikacijskiBrojInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "hrvatska-osobni-identifikacijski-broj-input");
