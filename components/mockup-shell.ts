...
//
// A decorative <div> that looks like a terminal shell, framing consumer-supplied
...
//
// References:
//   - components/mockup-shell/index.md (canonical contract)

import { applySelfClassName } from "../lib/dom-utils.js";

export class MockupShell extends HTMLElement {
    #built = false;
    ...
    connectedCallback(): void {
        ...
        applySelfClassName(this, "mockup-shell");
