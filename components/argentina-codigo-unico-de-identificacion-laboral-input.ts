...
//
// References:
//   - components/argentina-codigo-unico-de-identificacion-laboral-input/index.md (canonical contract)
...
export class ArgentinaCodigoUnicoDeIdentificacionLaboralInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "argentina-codigo-unico-de-identificacion-laboral-input");
