// RomaniaPasaportInput component
//
// A headless input for entering Romania's Pașaport.
...
//
// References:
//   - components/romania-pasaport-input/index.md (canonical contract)
...
export class RomaniaPasaportInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "romania-pasaport-input");
