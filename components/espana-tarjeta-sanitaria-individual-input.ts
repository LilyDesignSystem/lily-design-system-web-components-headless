...
//
// A headless input for entering an España Tarjeta Sanitaria Individual
...
//
// References:
//   - components/espana-tarjeta-sanitaria-individual-input/index.md (canonical contract)

import { passThroughAttributes, rootClassName } from "../lib/dom-utils.js";

const HANDLED = new Set(["label", "value", "required", "disabled", "autocomplete"]);

export class EspanaTarjetaSanitariaIndividualInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "espana-tarjeta-sanitaria-individual-input");
