...
//
// References:
//   - components/island-kennitala-input/index.md (canonical contract)
...
export class IslandKennitalaInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "island-kennitala-input");
