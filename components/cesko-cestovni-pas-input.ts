// CeskoCestovniPasInput component
//
// A headless input for entering Czech Republic's Cestovní pas.
...
//
// References:
//   - components/cesko-cestovni-pas-input/index.md (canonical contract)
...
export class CeskoCestovniPasInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "cesko-cestovni-pas-input");
