...
//
// A headless input for entering Thailand's เลขประจำตัวประชาชน (National ID).
...
//
// References:
//   - components/prathet-thai-lek-prajam-tua-prachachon-input/index.md (canonical contract)
...
export class PrathetThaiLekPrajamTuaPrachachonInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "prathet-thai-lek-prajam-tua-prachachon-input");
