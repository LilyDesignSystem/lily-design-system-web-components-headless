...
//
// References:
//   - components/zhongguo-jumin-shenfenzheng-haoma-input/index.md (canonical contract)
...
export class ZhongguoJuminShenfenzhengHaomaInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "zhongguo-jumin-shenfenzheng-haoma-input");
