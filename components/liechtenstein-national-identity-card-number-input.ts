...
//
// A headless input for entering Liechtenstein's national identity card number.
...
//
// References:
//   - components/liechtenstein-national-identity-card-number-input/index.md (canonical contract)
...
export class LiechtensteinNationalIdentityCardNumberInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "liechtenstein-national-identity-card-number-input");
