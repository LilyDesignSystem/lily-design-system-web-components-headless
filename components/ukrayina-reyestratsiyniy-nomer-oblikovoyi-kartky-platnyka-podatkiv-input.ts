...
//
// A headless input for entering Ukraine's Реєстраційний номер облікової картки платника податків (РНОКПП).
...
//
// References:
//   - components/ukrayina-reyestratsiyniy-nomer-oblikovoyi-kartky-platnyka-podatkiv-input/index.md (canonical contract)
...
export class UkrayinaReyestratsiyniyNomerOblikovoyiKartkyPlatnykaPodatkivInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "ukrayina-reyestratsiyniy-nomer-oblikovoyi-kartky-platnyka-podatkiv-input");
