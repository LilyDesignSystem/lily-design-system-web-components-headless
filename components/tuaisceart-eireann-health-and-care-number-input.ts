...
//
// A headless input for entering Tuaisceart Éireann (Northern Ireland)'s Health and Care (H&C) Number, a unique national healthcare identifier.
// Format: pattern XXX XXX XXXX ([0-9]{3} [0-9]{3} [0-9]{4}).
//
// Attributes:
...
//
// References:
//   - components/tuaisceart-eireann-health-and-care-number-input/index.md (canonical contract)

import { passThroughAttributes, rootClassName } from "../lib/dom-utils.js";

const HANDLED = new Set(["label", "value", "required", "disabled", "autocomplete", "pattern", "inputmode"]);

export class TuaisceartEireannHealthAndCareNumberInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "tuaisceart-eireann-health-and-care-number-input");
