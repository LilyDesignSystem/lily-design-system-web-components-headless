...
//
// A headless input for entering Belgium's Numéro de Registre National /
...
//
// References:
//   - components/belgique-numero-de-registre-national-input/index.md (canonical contract)
...
export class BelgiqueNumeroDeRegistreNationalInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "belgique-numero-de-registre-national-input");
