...
//
// References:
//   - components/ellada-dematerialised-securities-system-input/index.md (canonical contract)
...
export class ElladaDematerialisedSecuritiesSystemInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "ellada-dematerialised-securities-system-input");
