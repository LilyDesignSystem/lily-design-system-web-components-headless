// PolskaPeselInput component
//
// A headless input for entering Poland's PESEL.
...
//
// References:
//   - components/polska-pesel-input/index.md (canonical contract)
...
export class PolskaPeselInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "polska-pesel-input");
