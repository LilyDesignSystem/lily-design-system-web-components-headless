...
//
// References:
//   - components/lietuva-asmens-kodas-input/index.md (canonical contract)
...
export class LietuvaAsmensKodasInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "lietuva-asmens-kodas-input");
