...
//
// A headless input for entering Eire's Individual Health Identifier (IHI), a unique national healthcare identifier.
...
//
// References:
//   - components/eire-individual-health-identifier-input/index.md (canonical contract)

import { passThroughAttributes, rootClassName } from "../lib/dom-utils.js";

const HANDLED = new Set(["label", "value", "required", "disabled", "autocomplete", "pattern", "inputmode"]);

export class EireIndividualHealthIdentifierInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "eire-individual-health-identifier-input");
