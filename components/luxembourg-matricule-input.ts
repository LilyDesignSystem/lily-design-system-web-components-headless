...
//
// A headless input for entering Luxembourg's Numéro d'Identification Nationale (Matricule).
...
//
// References:
//   - components/luxembourg-matricule-input/index.md (canonical contract)
...
export class LuxembourgMatriculeInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "luxembourg-matricule-input");
