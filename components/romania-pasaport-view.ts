...
//
// A headless read-only display of Romania's Pașaport.
...
//
// References:
//   - components/romania-pasaport-view/index.md (canonical contract)
...
export class RomaniaPasaportView extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        span.className = rootClassName(this, "romania-pasaport-view");
