...
//
// References:
//   - components/polska-numer-identyfikacji-podatkowej-input/index.md (canonical contract)
...
export class PolskaNumerIdentyfikacjiPodatkowejInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "polska-numer-identyfikacji-podatkowej-input");
