...
//
// References:
//   - components/portugal-numero-de-identificacao-fiscal-input/index.md (canonical contract)
...
export class PortugalNumeroDeIdentificacaoFiscalInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "portugal-numero-de-identificacao-fiscal-input");
