...
//
// References:
//   - components/osterreich-sozialversicherungsnummer-input/index.md (canonical contract)
...
export class OsterreichSozialversicherungsnummerInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "osterreich-sozialversicherungsnummer-input");
