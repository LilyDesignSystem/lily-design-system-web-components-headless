...
//
// References:
//   - components/eesti-isikukood-input/index.md (canonical contract)
...
export class EestiIsikukoodInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "eesti-isikukood-input");
