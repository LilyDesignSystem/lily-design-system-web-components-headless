...
//
// References:
//   - components/sverige-personnummer-input/index.md (canonical contract)
...
export class SverigePersonnummerInput extends HTMLElement {
    ...
    connectedCallback(): void {
        ...
        input.type = "text";
        input.className = rootClassName(this, "sverige-personnummer-input");
